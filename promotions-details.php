    ...
    <section class="promos-list">
      ...
      <div class="container promocon">
        ...
        <div class="col-md-4 col-sm-8 p-0" >
             <img class="responsive" width="100%" src="images/promotions/<?=$row->url?>" title="<?=$row->title?>" alt="<?=$row->title?>">
          </div>
          <div class="col-md-8 col-sm-10" id="promoSingleContent" >
