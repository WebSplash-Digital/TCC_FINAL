    ...
    //    echo "<h1>@".$target_file."</h1>";
      if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
	   ...
	   /* -- */
		...
		$image = $img_url;
        $status = $_POST['status'];
        $query = "insert into latest_news(category,title, url, excerpt,description, title_image,  status,created_at) values('$category',:title,:url, :excerpt, :description, :image, '$status' , NOW()) ";
		try {
					...
					<div class="content">
						<div class="module">
							...
							<div class="module-body">
                                ...
                                <form action="add-latest-news.php" method="post" enctype="multipart/form-data">
								...
								<div class="control-group">
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<input type="text" placeholder="Enter News Title"  name="title" class="span8 tip" required>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label" for="basicinput">Excerpt</label>
										<div class="controls">
											<input type="text" placeholder="Enter News Excerpt"  name="excerpt" class="span8 tip" required>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label" for="basicinput">Description</label>
										<div class="controls">
											<textarea class="span8" name="description" rows="5" id="pageContent" required></textarea>
										</div>
									</div>
									<div class="control-group">
                                        ...
                                        <input type="radio" name="status" id="status0" value="0" checked> Not Published</label> </span>
                                        <span style="margin:1px">
                                        <label for="status1" class="lab">
									    <input type="radio" name="status" id="status1" value="1"> Published </label></span> 
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
                                        <input type="file" name="fileToUpload" id="fileToUpload" accept="image/png, image/jpeg, image/jpeg"  onchange="ValidateSingleInput(this);" required >
										</div>
									</div>
									<div class="control-group">
										<div class="controls">
											<button type="submit" name="submit" class="btn" id="submitBtn">Create</button>
										</div>
									</div>
								</form>
							</div>
