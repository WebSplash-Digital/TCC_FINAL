...
else
{
    ...
    $status = $_POST['status'];
    $query = "insert into tcc_professionals (`name`, `designation`, `photo`, `display_order`, `status`, `created_at`) values('$name', '".$designation."' ,'".$img_url."','$display_order' , '$status' , NOW()) ";
		$res =mysqli_query($con,$query);
		if($res ==1) {
			$_SESSION['msg']="New Record Created !!";
		}else  {
	...
	if(isset($_GET['del']))
	{
        ...
        $_SESSION['delmsg']="Professional deleted !!";
	}
						...
						<div class="module">
							...
							<div class="module-body">
                                ...
                                <form action="<?=$_SERVER['PHP_SELF']?>" method="post" enctype="multipart/form-data">
										...
										<div class="controls">
											<input type="text" placeholder="Enter Professional Name"  name="name" class="span8 tip" required>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label" for="basicinput">Designation</label>
										<div class="controls">
                                        <input type="text" placeholder="Enter Professional Designation"  name="designation" class="span8 tip" required>
										</div>
									</div>
									<div class="control-group">
                                    ...
                                    <div class="control-group">
										<label class="control-label" for="basicinput">Disp Position</label>
										<div class="controls">
