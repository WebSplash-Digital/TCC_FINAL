...
else
{
   ...
   //   echo "Sorry, your file is too large.";
    ...
    $img = " ";
       ...
       $query = "update promotions set title ='".$title."',`description` ='".$description."',  $img  status = $status, updated_at = NOW() where id = '$id'";
     //  echo "<h6>  $query  </h6>";
		$res =mysqli_query($con,$query);
		if($res ==1) {
            
			$_SESSION['msg']="Promotion Updated !!";
		}else  {
					...
					<div class="content">
						<div class="module">
							...
							<div class="module-body">
                                ...
                                <form action="edit-promotions.php" method="post" enctype="multipart/form-data">
								<?php
                                if($_POST) {
                                    $id=intval($_POST['id']);
                                } else {
                            ...
                            $query=mysqli_query($con,"select * from promotions where id='$id'");
                            while($row=mysqli_fetch_array($query))
                            {
                                ?>	
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea class="span8" name="description" rows="5" id="pageContent" required><?=$row['description']?></textarea>
										</div>
									</div>
                                    <div class="control-group">
