...
else
{
	...
	if(isset($_POST['submit']))
	{
	   ...
	   /* -- */
		...
		$title = addslashes($_POST['faq_title']);
		$description = addslashes($_POST['faq_description']);
	     $status = $_POST['status'];

		try {	
			$query = "insert into faq_mst (faq_type, faq_title, faq_description,  status,created_at) values('$category',:title,:description,  '$status' , NOW()) ";

			$query = $dbh->prepare($query);
			$query->bindParam(':title', $title, PDO::PARAM_STR);
			$query->bindParam(':description', $description, PDO::PARAM_STR);
			$res = $query->execute();
			$_SESSION['msg']="FAQ Created !!";
		} catch (Exception $e) {
							...
							<div class="module-body">
								...
								<div class="control-group">
										...
										<div class="controls">
                                            ...
                                            <option value="landline">Prepaid Fixed Line / Landline</option>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<input type="text" placeholder="Enter FAQ Title"  name="faq_title" class="span8 tip" required>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label" for="basicinput">Faq Description</label>
										<div class="controls">
											<textarea class="span8" name="faq_description" rows="5" id="pageContent" required></textarea>
										</div>
									</div>
									<div class="control-group">
