...
else
{
    ...
    //    echo "<h1>#".$_FILES["fileToUpload"]["tmp_name"]."</h1>";
    //    echo "<h1>@".$target_file."</h1>";
      if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
       ...
       // echo  htmlspecialchars( basename( $_FILES["fileToUpload"]["name"])). " has been uploaded.";
		...
		try {		
			$query = "insert into banners (`banner_title`,  `banner_desc`,`banner_href_url`,  `banner_image_url`,`banner_position`,  `status`, `created_at`) values(:title,:banner_desc, '".$banner_href_url."', '".$img_url."' , '".$banner_position."', '$status' , NOW()) ";
					...
					<div class="content">
						<div class="module">
							...
							<div class="module-body">
								...
								<?php
								header('Refresh: 3; URL=banners.php');
								} 
								 if(isset($_GET['del']))
								{?>
                                ...
                                <form action="<?=$_SERVER['PHP_SELF']?>" method="post" enctype="multipart/form-data">
								    <div class="control-group">
										...
										<div class="controls">
											<input type="text" placeholder="Enter Banner Title"  name="banner_title" class="span8 tip" required>
										</div>
									</div>
                                    <div class="control-group">
										<label class="control-label" for="basicinput">Banner Description</label>
										<div class="controls">
											<input type="text" placeholder="Banner Description"  name="banner_desc" class="span8 tip" required>
										</div>
									</div>
                                    <div class="control-group">
										<label class="control-label" for="basicinput">Banner Link URL</label>
										<div class="controls">
											<input type="text" placeholder="Banner Link URL"  name="banner_href_url" class="span8 tip" required>
										</div>
									</div>
									<div class="control-group">
									...
									<div class="control-group">
										<div class="controls">
											<button type="submit" name="submit"  id="submitBtn" class="btn">Create</button>
										</div>
									</div>
								</form>
							</div>
