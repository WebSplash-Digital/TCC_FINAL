...
else
{
    ...
    $status = $_POST['status'];
		try {
		$query = "insert into page_topbanner (`page_name`, `title`, `banner_img`,  `status`, `created_at`) values(:page_name, :title ,'".$img_url."', '$status' , NOW()) ";
						...
						<div class="module">
							...
							<div class="module-body">
                                ...
                                <form action="<?=$_SERVER['PHP_SELF']?>" method="post" enctype="multipart/form-data">
										...
										<label class="control-label" for="basicinput">Page_Name</label>
										<div class="controls">
											<input type="text" placeholder="Enter page_name"  name="page_name" class="span8 tip" required>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label" for="basicinput">Title</label>
										<div class="controls">
                                        <input type="text" placeholder="Enter Page Title"  name="title" class="span8 tip" required>
										</div>
									</div>
									<div class="control-group">
