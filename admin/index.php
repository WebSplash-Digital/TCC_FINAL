...
if(isset($_POST['login'])) 
  {
    ...
    $sql ="SELECT ID,Role FROM tbladmin WHERE UserName=:username and Password=:password";
    ...
    if($query->rowCount() > 0)
    {
        ...
        if($_SESSION['alogin']=="shopadmin"){
            echo "<script type='text/javascript'> document.location ='todays-orders.php'; </script>";
        }else{
                            ...
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    <a class="link-effect font-w700" href="index.php">
                                        ...
                                        <span class="font-size-xl">Admin Portal </span>
                                    </a>
