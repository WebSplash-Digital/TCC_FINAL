                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidebar-content">
                            ...
                            <div class="sidebar-mini-hidden-b text-center">
                                ...
                                <ul class="list-inline mt-10">
                                    <?php
                                        ...
                                        $sql="SELECT AdminName,Role from  tbladmin where ID=:aid";
                        ...
                        <div class="content-side content-side-full">
                            ...
                            if(isset($_SESSION['role']) && $_SESSION['role'] == 'hradmin'){
                                ?>
                                   <ul class="nav-main">
                                <li class="open">
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu">
                                        ...
                                        <span class="sidebar-mini-hide"></span>Job Category 
                                    </a>
                                    <ul>
                                        <li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu">
                                        <i class="si si-puzzle"></i>
                                        <span class="sidebar-mini-hide"></span>Post Job
                                    </a>
                                    <ul>
                                        <li>
                                            <a href="post-job.php">Add Job Post</a>
                                        </li>
                                        <li>
                                            <a href="manage-job-post.php">Manage Post Job</a>
                                        </li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu">
                                        <i class="si si-puzzle"></i>
                                        <span class="sidebar-mini-hide"></span>Applied Job By Candidates
                                    </a>
                                    <ul>
                                        <li>
                                            <a href="applied-job-list.php">Aplied Job List</a>
                                        </li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu">
                                         <i class="si si-puzzle"></i>
                                        <span class="sidebar-mini-hide"></span>Manage Coupon
                                    </a>
                                    <ul>
                                        <li> 
                                        ...
                                        <li>
                                            <a href="manage-coupon.php">Manage Coupon</a>
                                        </li>
                                ...
                                <?php if($row->Role=="jobadmin"){}else{ ?>
                                <li>
                                    <a href="todays-orders.php"><i class="si si-cup"></i><span class="sidebar-mini-hide">Go to Shop Portal</span></a>
                                </li>
                            <?php } ?>
                            </ul> 
                                <?php
