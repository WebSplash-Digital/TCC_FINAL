...
//Getting User Id
$uid=$_SESSION['jsid'];
$sql="insert into tblexperience(UserID,EmployerName,EmployementType,Designation,Ctc,Skills,FromDate,ToDate)values(:uid,:employername,:toe,:desi,:ctc,:skills,:fdate,:tdate)";
...
<div class="col-md-6 col-sm-6">
<label>Skills</label>
 <input type="text" name="skills" placeholder="PHP,PDO,HTML etc" autocomplete="off" value="" class="form-control">
</div>
