...
<html lang="en">
	<head>
		...
		<!--[if lt IE 9]>
			<script src="shop_assets/js/html5shiv.js"></script>
			<script src="shop_assets/js/respond.min.js"></script>
		<![endif]-->
...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img src="shop_assets/images/banners/cat-banner-2.jpg" alt="" class="img-responsive">
			</div>
...
{?>							
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><img  src="shop_assets/images/blank.gif" data-echo="shop_admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" alt="" width="200" height="300"></a>
			</div><!-- /.image -->			                      		   
		</div><!-- /.product-image -->
