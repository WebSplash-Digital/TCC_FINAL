...
else
{
  if(isset($_POST['submit']))
  {
      ...
      $sql1="update admin set AdminName=:adminname,Email=:email where id=:aid";
      $query1 = $dbh->prepare($sql1);
      $query1->bindParam(':adminname',$AName,PDO::PARAM_STR);
      $query1->bindParam(':email',$email,PDO::PARAM_STR);
      $query1->bindParam(':aid',$adminid,PDO::PARAM_STR);
      $query1->execute();
