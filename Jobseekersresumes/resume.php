     ...
     <?php if(@$error){ ?><div class="errorWrap">
        ...
        <strong>Success</strong> : <?php echo htmlentities($msg);?></div><?php } ?>
          ...
          <div class="row">
            ...
            <label><?php echo $status = (empty($result->Resume)) ? "Upload Resume " : "Update Resume "; ?></label>
            ...
            <div class="col-md-12" >
              ...
              <div class="btn-col">
                ...
                <input type="submit" name="update" value="<?php echo $status = (empty($result->Resume)) ? "Upload" : "Update"; ?>">
