...
// Query for Insertion
$isactive=1;
$sql="INSERT INTO tbljobseekers(FullName,EmailId,ContactNumber,Password,ProfilePic,IsActive) VALUES(:fname,:emaill,:cnumber,:hashedpass,:ProfilePicname,:isactive)";
$query = $dbh->prepare($sql);

$sql1="INSERT INTO users(name,email,contactno,ProfilePic) VALUES(:fname,:emaill,:cnumber,:ProfilePicname)";
