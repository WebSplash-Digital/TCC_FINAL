...
<div id="wrapper"> 
  ...
  <!--INNER BANNER END--> 
    ...
    <ul class="breadcrumb" style="margin-left:9%;padding-top:1%;padding-bottom:1%;margin-right:9%;">
...
{               ?>
 ...
 <?php } else { ?>
      <a href="my-profile.php" class="btn-style-1">Upload Resume</a> 
      <?php } ?>   
...
<?php } else { ?>
  <a href="my-profile.php" class="btn-style-1 style-big">Upload Resume</a> 
  <?php } ?>
                </div>
