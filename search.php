         ...
         <!-- <img src="<?=BASE_URL?>shop_admin/productimages/<?=$data1->id?>/<?=$data1->productImage1?>" width=100px height=100px>  -->
          <div class="col-sm-1">
            <h5 class="text-secondary">
              <?php
              if($data->type == 'product') { echo '<i class="fa fa-cart-plus fa-4x" aria-hidden="true"></i>';}
              elseif($data->type == 'faq')  { echo '<i class="fa fa-question-circle-o fa-4x" aria-hidden="true"></i>';}
              elseif($data->type == 'news') { echo '<i class="fa fa-newspaper-o fa-4x" aria-hidden="true"></i>';}
              elseif($data->type == 'promotions') { echo '<i class="fa fa-info-circle fa-4x" aria-hidden="true"></i>';}
              elseif($data->type == 'plan') { echo '<i class="fa fa-file-text-o fa-4x" aria-hidden="true"></i>';}
              elseif($data->type == 'job') { echo '<i class="fa fa-font-awesome fa-4x" aria-hidden="true"></i>';}
              ?>
            </h5>
          </div>
          ...
          <div class="col-sm-11">
            ...
            <h5 class="text-secondary">
              <?php
              if($data->type == 'product') { echo "Products";}
              elseif($data->type == 'faq')  { echo "FAQ";}
              elseif($data->type == 'news') { echo "Latest News";}
              elseif($data->type == 'promotions') { echo "Promotion";}
              elseif($data->type == 'plan') { echo "Plan";}
              elseif($data->type == 'job') { echo "Job";}
              ?>
            </h5>
            <h4><?=$data->title?></h4>
            ...
            <h5>
              ...
              elseif($data->type == 'faq')  { 
                echo "<a href='faq.php?faqid=".$data->id."'>Click Here</a>";}
