              ...
              <div class="panel panel-default">
                <div class="" role="tab" id="heading<?=$row->id?>">
                  <h4 class="panel-title">
                    <a role="button" class="<?php echo ($row->id != $var) ? 'collapsed ' : '';?> faqtitlehead faqsheading" data-toggle="collapse" data-parent="#accordion" href="#collapse<?=$row->id?>" aria-expanded="<?php echo ($row->id != $var) ? 'false ' : 'true';?>" aria-controls="collapse<?=$row->id?>">
                    <?=$row->faq_title?> 
                ...
                <div id="collapse<?=$row->id?>" class="panel-collapse collapse <?php echo ($row->id != $var) ? '' : ' in';?>" role="tabpanel" aria-labelledby="heading<?=$row->id?>">
          ...
          <div class="col-md-12" id="main">
            ...
            if(isset($_GET['faqid'])) {
              ...
              <div class="panel panel-default">
                <div class="" role="tab" id="heading<?=$row->id?>">
                  <h4 class="panel-title">
                    <a role="button" class="<?php echo ($row->id != $var) ? 'collapsed ' : '';?>faqtitlehead faqsheading" data-toggle="collapse" data-parent="#accordion1" href="#collapse<?=$row->id?>" aria-expanded="<?php echo ($row->id != $var) ? 'false ' : 'true';?>" aria-controls="collapse<?=$row->id?>">
                    <?=$row->faq_title?>
                      <i class="fa fa-long-arrow-up" aria-hidden="true"></i>
                    </a>
          ...
          <div class="col-md-12" id="main">
            ...
            if(isset($_GET['faqid'])) {
              ...
              <div class="panel panel-default">
                <div class="" role="tab" id="heading<?=$row->id?>">
                  <h4 class="panel-title">
                    <a role="button" class="<?php echo ($row->id != $var) ? 'collapsed ' : '';?> faqtitlehead faqsheading" data-toggle="collapse" data-parent="#accordion3" href="#collapse<?=$row->id?>" aria-expanded="<?php echo ($row->id != $var) ? 'false ' : 'true';?>" aria-controls="collapse<?=$row->id?>">
                    <?=$row->faq_title?>
                      <i class="fa fa-long-arrow-up" aria-hidden="true"></i>
                    </a>
