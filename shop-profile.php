  ...
  else
  {
    ...
    // print_r($_POST['submit']); die;
      if(isset($_POST['submit']))
      {
        ...
        //   echo $img_url1; die;
          $sql="UPDATE `tbljobseekers` SET `FullName`='$FullName',`EmailId`='$EmailId',`ContactNumber`='$ContactNumber',`ProfilePic`='$img_url1',`address`='$address',`suburb`='$suburb',`state`='$state',`city`='$city',`pincode`='$pincode' WHERE `id`='$editid'";
    ...
    <div class="container mt-5">
        <div class="row tcc_dashboard">
            ...
            <div class="col-lg-8 tcc_dashboard_body">
                ...
                <h3 class="pb-3 dasboard_heading">Overview</h3>
                <div class="dashboard_body_cards">
                    <div class="dashboard_body_two">
                        ...
                        <div class="quick_info">
                            ...
                            <?php
								$results = orderdetails($_SESSION['id']);
								
							?>
								
							
                                <h3><?php echo $results[0]->count; ?></h3>
                           
                                <p>Successful Orders</p>
                            </div>
                            <span class="material-symbols-outlined quick_info_icon"> task_alt </span>
                        </div>
                        <div class="quick_info">
                            <div class="info1">
                            <?php	
                                $results1 = pendingorderdetails($_SESSION['id']);
							?>
							
                                <h3><?php echo $results1[0]->count; ?></h3>
                            
                                <p>Pending Orders</p>
                            </div>
                            <span class="material-symbols-outlined quick_info_icon"> deployed_code_history </span>
                        </div>
                        <div class="quick_info">
                            <div class="info1">
                            <?php	
								 $results2 = pendingorderdetails($_SESSION['id']);
							?>
							
							
                            <h3><?php echo $results2[0]->count; ?></h3>
                ...
                <div class="dashboard_body_cards ">
                    ...
                    ?>
                    <form action="shop-profile.php" method="POST" id="jobMyProfile" enctype="multipart/form-data" class="pt-5">
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" placeholder="City" name="city" value="<?php echo $userDeatils[0]->city; ?>">
                        ...
                        <div class="d-grid gap-2">
                            <!-- <input type="submit" class="tcc_btn mt-4" name="submit" value="Save Profile" id=""> -->
