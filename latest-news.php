...
<section id="inner-banner" class="bgimgservices bgimgnews" style="background-image: url('images/banners/<?=$row[0]->banner_img?>');">
        ...
        <div class="row">
          <div class="col-md-8 col-sm-12">
            ...
            <div class="row">
              ...
              <?php
       if(isset($_GET['cat'])) {
        $sql="select * from latest_news where status = 1  and category = '".$_GET['cat']."' order by id desc limit 10";
    } else {
        ...
        ?>
                <div class="blog">
                  ...
                  <h3><?php echo substr($row->title,0,150);?></h3>
                  <p><?php echo substr($row->excerpt,0,120);?> </p>
                  <a href="news-details/<?php echo $row->url;?>" class="readMorebtn">Read More <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                </div>
        <?php }
        } else {
           ?> <div class="blog">
          ...
          <div class="col-md-4 col-sm-12 blogSidebar">
            <div class="recentPostSec">
              ...
              <ul class="recentPostList">
                ...
                { ?>
                <li>
                  <a href="news-details/<?php echo $row->url;?>" >
