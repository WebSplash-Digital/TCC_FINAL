      ...
      <section class="promos-list shopcon">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 shopbanner">
              ...
              <p><input type="hidden" name="category" value="<?= $_GET['cat_id'] ?>" id="category">
                <input type="hidden" name="sort" value="" id="sort_value">
        ...
        <div class="container-fluid shopbody">
          <div class="row">
            ...
            <div class="col-md-10 col-sm-12 col-xs-12" id="productBody">
              <!-- card row start -->
              <?php
              ...
              foreach ($products as $i => $data) {
                if ($start == 'Y') {
                  echo '<div class="container"><div class="row shoprow start flex" >';
                  $start = 'N';
                }
              ?>
                <div class="col-sm-6 col-md-6 col-sm-4 ">
                  <div class="shopcard text-center ">
                    <img class="shopimg" src="admin/productimages/<?php echo $data->id; ?>/<?php echo $data->productImage1; ?>" alt="<?= $data->productName ?>">
        ...
        <!--- Pagination Starts -->
        <nav class="pagenavigation" aria-label="Page navigation example">
          <ul id="pagination-demo" class="pagination justify-content-center">
            <?php
            $page = ceil($count / $prodPerPage);
            if ($page > 1) {
              for ($i = 1; $i <= $page; $i++) {
                echo '<a href="#product"><span style="height:24px;background-color:blue;color:#fff;font-size:18px;font-weight:300;border:none;outline:none;margin:10px;padding:15px" class="page" data-id="' . $i . '" id="pageid' . $i . '" >' . $i . '</span></a>';
              }
            }
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-6 quickviewinfo">
              <a href="#">
                <h5 class="pagetitle">Mobiles</h5>
              </a>
              <a href="#" id="produrl">
                <h4 class="producttitle">
                  <div id="pname">Samsung Fold 3</div>
                </h4>
              </a>
          ...
          success: function(data) {
            ...
            if (totProduct > prodPerPage) {
              ...
              for (let i = 1; i <= page; i++) {
                var str2 = '<a href="#product"><span style="height:24px;background-color:blue;color:#fff;font-size:18px;font-weight:300;border:none;outline:none;margin:10px;padding:15px" class="pageX" data-id="' + i + '"  id="pageid' + i + '">' + i + '</span></a>';
