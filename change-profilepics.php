...
$sql1="update users set ProfilePic=:img where id=:id";
...
$query1->bindParam(':img',$img,PDO::PARAM_STR);
$query1->execute();
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <img src="images/<?php echo $result->ProfilePic;?>" width="100" height="100"
                                    value="<?php  echo $result->ProfilePic;?>"><br />
                            </div>
