...
?>
				<tr>
					...
					<td class="cart-product-sub-total">T$ <?php echo $price= displayPrice($row['pprice']); ?>  </td>
					<td class="cart-product-sub-total">T$ <?php echo $shippcharge= displayPrice($row['shippingcharge']); ?>  </td>
					<td class="cart-product-grand-total">T$ <?php echo displayPrice((($qty*$price)+$shippcharge));?></td>
